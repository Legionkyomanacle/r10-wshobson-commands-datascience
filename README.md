...
> **Adaptation of `wshobson/commands` for Data Science & AI/ML use cases.**
...
```bash
# Clone this skill
cp -r . ~/.claude/skills/r00-wshobson-commands--datascience/

# Register in Claude Code
# In a Claude Code session:
/read ~/.claude/skills/r00-wshobson-commands--datascience/SKILL.md
```
